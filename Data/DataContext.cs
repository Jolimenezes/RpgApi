...
namespace RpgApi.Data
{
    public class DataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            (
                new Personagem() { Id = 1, Nome = "Ichigo", PontosVida = 100, Forca = 17, Defesa = 23, Inteligencia = 33, Classe = ClasseEnum.Cavaleiro, UsuarioId = 1 },
                new Personagem() { Id = 2, Nome = "Alucard", PontosVida = 100, Forca = 15, Defesa = 25, Inteligencia = 30, Classe = ClasseEnum.Cavaleiro, UsuarioId = 1 },
                new Personagem() { Id = 3, Nome = "Toji", PontosVida = 100, Forca = 18, Defesa = 21, Inteligencia = 35, Classe = ClasseEnum.Clerigo, UsuarioId = 1 },
                new Personagem() { Id = 4, Nome = "Sukuna", PontosVida = 100, Forca = 18, Defesa = 18, Inteligencia = 37, Classe = ClasseEnum.Mago, UsuarioId = 1 },
                new Personagem() { Id = 5, Nome = "Crona", PontosVida = 100, Forca = 20, Defesa = 17, Inteligencia = 31, Classe = ClasseEnum.Cavaleiro, UsuarioId = 1 },
                new Personagem() { Id = 6, Nome = "Link", PontosVida = 100, Forca = 21, Defesa = 13, Inteligencia = 34, Classe = ClasseEnum.Clerigo, UsuarioId = 1 },
                new Personagem() { Id = 7, Nome = "Pequeno fantasma", PontosVida = 100, Forca = 25, Defesa = 11, Inteligencia = 35, Classe = ClasseEnum.Mago, UsuarioId = 1 }
            );

            modelBuilder.Entity<Arma>().HasData
           (
                new Arma() { Id = 1, Nome ="Zangetsu", Dano = 25, PersonagemId = 1 },
                new Arma() { Id = 2, Nome ="Cassull & Chacal", Dano = 10, PersonagemId = 2 },
                new Arma() { Id = 3, Nome ="Lança Invertida do Céu", Dano = 20, PersonagemId = 3 },
                new Arma() { Id = 4, Nome ="Kamutoke", Dano = 35, PersonagemId = 4 },
                new Arma() { Id = 5, Nome ="Ragnork Demon", Dano = 45, PersonagemId = 5 },
                new Arma() { Id = 6, Nome ="Master Sword", Dano = 50, PersonagemId = 6 },
                new Arma() { Id = 7, Nome ="Ferrão Puro", Dano = 21, PersonagemId = 7 }
           );
